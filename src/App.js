  ...
  return (
    <div className="max-w-8xl mx-auto px-4 py-4 items-center sm:px-6 font-roboto">
      <h2 class="text-center text-yellow-500 card-title text-4xl py-4">
        ...
        Binance
        <div class="badge bg-white border-green-600 text-green-700 px-3"><div className="w-1 h-1 bg-green-400 ring-2 ring-green-300 rounded-full dark:border-gray-900 dark:bg-gray-700"></div><div className="px-1"></div>Active</div>
      </h2>
      ...
      <div className="grid grid-rows-3 gap-2">
        ...
        <Screener2 />
        <Screener3 />
        <p className="text-lg font-bold text-gray-700 text-center py-4">Subscribe to see <span className="text-red-600">sell</span> screeners. Pricing starts at <span className="text-indigo-600">$4 a month per screener.</span></p>
        <Screener4 />
        <Screener4 />
        <Screener5 />
        <Screener5 />
      </div>
      <footer class="footer items-center p-4 bg-white text-lg text-black text-neutral-content">
