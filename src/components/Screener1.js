            ...
            <div class="justify-items-start card shadow-lg shadow-red-200 h-full bg-gradient-to-r from-red-400 to-red-300 ">
              <div class="card-body">
                <h2 class="card-title text-2xl">
                  ...
                  <div class="badge bg-red-700">-0.6%</div>
                </h2>
                <p>Trade the BTC-USDT Pair now on Binance</p>
                <div class="card-actions justify-end">
                  <div class="badge bg-red-100 text-red-900 font-bold ring-2 ring-red-400 px-3">$1.00</div> 
          ...
          <div className="justify-items-start">
            <div className="justify-items-start">
                ...
                <div class="card-body">
                    ...
                    <div class="badge bg-green-700">+3.22%</div>
                    </h2>
                    <p>Trade the BTC-DOGE Pair now on Binance</p>
                    <div class="card-actions justify-end">
                    <div class="badge bg-green-100 text-green-900 font-bold ring-2 ring-green-400 px-3">$0.06</div> 
                    <div class="badge bg-green-100 text-green-900 font-bold ring-2 ring-green-400 px-3 ">High</div>
                    </div>
                </div>
                </div>
            ...
            <div class="justify-items-start card shadow-lg shadow-green-200 h-full bg-gradient-to-r from-green-400 to-green-300 ">
              <div class="card-body">
                <h2 class="card-title text-2xl">
                  ...
                  <div class="badge bg-green-700">+5.89%</div>
                </h2>
                <p>Trade the BTC-Matic Pair now on Binance</p>
                <div class="card-actions justify-end">
                  <div class="badge bg-green-100 text-green-900 font-bold ring-2 ring-green-400 px-3">$0.78</div> 
                  <div class="badge bg-green-100 text-green-900 font-bold ring-2 ring-green-400 px-3 ">High</div>
                </div>
              </div>
            </div>
            ...
            <div class="justify-items-start card shadow-lg shadow-red-200 h-full bg-gradient-to-r from-red-400 to-red-300 ">
              <div class="card-body">
                <h2 class="card-title text-2xl">
                  ...
                  <div class="badge bg-red-700">-2.45%</div>
                </h2>
                <p>Trade the BTC-Solana Pair now on Binance</p>
                <div class="card-actions justify-end">
                  <div class="badge bg-red-100 text-red-900 font-bold ring-2 ring-red-400 px-3">$34.23</div> 
                  <div class="badge bg-red-100 text-red-900 font-bold ring-2 ring-red-400 px-3 ">Low</div>
                </div>
              </div>
            </div>
          </div>
